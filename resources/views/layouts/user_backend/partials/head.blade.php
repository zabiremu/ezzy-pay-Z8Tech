<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('backend/css/bootstrap-icons.css')}}">
    <link rel="stylesheet" type="text/css"
    ...
    <link
        ...
        rel="stylesheet">
    <script src="https://kit.fontawesome.com/30bc4b7242.js" crossorigin="anonymous"></script>
    <style>
        body {
